...
type EmailData = ContactData | AppointmentData | DownloadBrochure;
...
export async function SendGridEmail(data: any) {
    ...
    switch (data.type) {
        case 'contact':
            subject = '🔔 New Contact Form Submission | Ionic Engineering';
            emailContent = {
                text: `
                ...
                html: `
                    ...
                    <body>
                        <div class="container">
                            <div class="header">
                                <img src="https://ionic.co.in/images/logo-white.png" alt="Ionic Engineering" class="logo">
        ...
        case 'appointment':
            subject = '📅 New Appointment Request | Ionic Engineering';
            emailContent = {
                text: `
        ...
        case 'download':
            subject = '📥 New Brochure Download | Ionic Engineering';
            emailContent = {
                text: `
...
const getBrochureDownloadEmailTemplate = (data: DownloadBrochure) => {
    const subject = `Your Requested Brochure - ${data.brochure.name} | Ionic Engineering Technology`;
