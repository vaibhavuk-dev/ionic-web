    ...
    return (
        <div className="w-full h-full px-7 relative flex flex-col items-center justify-center md:items-start md:overflow-hidden md:px-0 lg:px-0 bg-white py-5">
            ...
            <div className="flex flex-col gap-2">
                    <p className="text-3xl font-semibold">Case Studies</p>
                    <div className=" flex gap-2 justify-between">
                        <p className="text-xl w-[80%] font-light">Explore our recent water, wastewater, and reuse projects from across the globe.</p>
                        <p className="text-lg font-light">View all case studies<img className="w-5 h-5 inline" src="/right-arrow.svg" alt="" /></p>
                    </div>
                </div>
