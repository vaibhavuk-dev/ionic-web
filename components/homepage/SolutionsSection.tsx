...
export default function SolutionsSection() {
  const solutions = [
    ...
    },
    {
      ...
      image: "/homepage/oursolutions/ionicintegrated.png",
      description:
        "Ionic Provides integrated solutions for zero liquid discharge and water recycling systems. Ionic can provide evaporators for achieving zero discharge requirements from industries and processes using which water can be easily recycled.",
