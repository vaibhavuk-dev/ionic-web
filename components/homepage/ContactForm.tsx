...
export default function ContactForm({ shouldShowHeader = true }: any) {
  ...
  return (
    <div
      className="w-full relative bg-white mx-auto  container"
      id="contact-form"
    >
      {shouldShowHeader && (
        <h1 className="text-4xl font-bold text-headlineColor mb-8">
            ...
            <div className="w-full h-1/2 flex flex-col md:grid grid-cols-2 gap-12">
              ...
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="ml-4 text-xl font-semibold text-textcolorDark">
                    Email
                  </h2>
                </div>
              ...
              <div className="col-span-2">
                ...
                <p className="text-textcolor">
                  <b>IONIC ENGINEERING TECHNOLOGY PVT LTD</b>
                  <br />
          ...
          <div className="w-full bg-primary rounded-2xl p-2 md:p-8">
            ...
            {activeTab === "contact" ? (
              ...
              <form onSubmit={handleAppointmentSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="purpose" className="block text-white mb-2">
                    Purpose of Meeting
                  </label>
                  <textarea
                    id="purpose"
