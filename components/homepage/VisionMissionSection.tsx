...
export default function VisionMissionSection() {
  const features = [
    ...
    {
      title: "OUR MISSION",
      subtitle: "To Treat Water Differently",
      description: "IONIC will be a performance oriented and customer centric company to present globally with innovative products.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Our team is dedicated to engineering advanced technologies that redefine the standards of water treatment and sustainability.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "OUR QUALITY",
      subtitle: "Redefining Excellence in Water",
      description: "Over 27 years of extensive expertise in water management to deliver innovative and effective solutions in Water Treatment.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
