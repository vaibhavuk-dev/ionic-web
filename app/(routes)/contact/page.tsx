...
export default function ContactPage() {
    ...
    return (
        <div>
            ...
            <div className="container lg:flex w-full gap-10 bg-white responsive-padding py-16 rounded shadow-md relative">
                ...
                <form className="w-full lg:w-[40%]">
                    ...
                    <div>
                        <button type="submit" className="w-full bg-greeng-600 text-white font-semibold py-2 px-4 rounded hover:bg-blue-700">{contactType == "Appointment" ? "Schedule Appointment" : "Send Message"}</button>
                    </div>
                </form>
